...
# La URL de conexión viene de las variables de entorno (app.core.config),
# nunca del alembic.ini, para que local y Railway coincidan.
...
from app.inteligencia import models as inteligencia_models  # noqa: F401
